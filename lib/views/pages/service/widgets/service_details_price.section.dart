      ...
      [
        ...
        CurrencyHStack(
          [
            "${AppStrings.currencySymbol}"
                ...
                .make(),
            service.price.currencyValueFormat().text.semiBold.color(AppColor.primaryColor).xl2.make(),
          ],
        ),
        ...
        Visibility(
          ...
          child: service.showDiscount
              ? ("${AppStrings.currencySymbol}${service.price - service.discountPrice}".currencyFormat()+" ${'Off'.i18n}")
                  .text
                  .white
                  .semiBold
                  .make()
